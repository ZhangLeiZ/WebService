...
public class ObjectFactory {
    ...
    private final static QName _User_QNAME = new QName("http://server.zl.com/", "User");
    ...
    private final static QName _GetUserBy_QNAME = new QName("http://server.zl.com/", "getUserBy");
    private final static QName _GetUserByResponse_QNAME = new QName("http://server.zl.com/", "getUserByResponse");
    ...
    /**
     * Create an instance of {@link GetUserBy }
     * 
     */
    public GetUserBy createGetUserBy() {
        return new GetUserBy();
    }

    /**
     * Create an instance of {@link GetUserByResponse }
     * 
     */
    public GetUserByResponse createGetUserByResponse() {
        return new GetUserByResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.zl.com/", name = "User")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetUserBy }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://server.zl.com/", name = "getUserBy")
    public JAXBElement<GetUserBy> createGetUserBy(GetUserBy value) {
        return new JAXBElement<GetUserBy>(_GetUserBy_QNAME, GetUserBy.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetUserByResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://server.zl.com/", name = "getUserByResponse")
    public JAXBElement<GetUserByResponse> createGetUserByResponse(GetUserByResponse value) {
        return new JAXBElement<GetUserByResponse>(_GetUserByResponse_QNAME, GetUserByResponse.class, null, value);
    }
